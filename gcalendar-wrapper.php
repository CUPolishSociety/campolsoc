 ...
 */
$calColorBgDark      = '#12120F';	// dark background color
$calColorTextOnDark  = '#FF8B04';	// text appearing on top of dark bg color
$calColorBgLight     = '#12120F';	// light background color
$calColorTextOnLight = '#FF8B04';	// text appearing on top of light bg color
$calColorBgToday     = '#CF9911';	// background color for "today" box
